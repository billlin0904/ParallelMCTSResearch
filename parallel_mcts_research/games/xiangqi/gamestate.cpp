...
std::vector<XiangQiGameMove> Rules::GetMaLegalMove(Colors, int8_t row, int8_t col, const BoardStates& board) {
	std::vector<XiangQiGameMove> moves;
...
std::vector<XiangQiGameMove> Rules::GetShiLegalMove(Colors color, int8_t row, int8_t col, const BoardStates&) {
	if (row == 2 || row == 9) {
